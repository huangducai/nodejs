...
MaxRectsBinPack.prototype = {
    ...
    insert2: function (rectangles, method) {
        ...
        while (rectangles.length > 0) {
            ...
            if (bestRectangleIndex == -1) {
                console.log('------ bestRectangleIndex ==' + bestRectangleIndex);
                return res;
            }
    ...
    _findPositionForNewNodeBestShortSideFit: function (width, height, bestShortSideFit, bestLongSideFit) {
        ...
        // console.log('bestNode = ' + JSON.stringify(bestNode, null, 4));
        return bestNode;
    },
...
//
//
// var ddd = new MaxRectsBinPack(2048, 2048, true);
//
// for (var i = 0; i < 5; i++) {
//     // var data = ddd.insert2([{width: 10, height: 10}]);
//     var data = ddd.insert(10, 10);
//     console.log('----- index:' + JSON.stringify(data, null, 4));
// }

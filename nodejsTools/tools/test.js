...
// var allFile = ToolsHelper.getFileList('../svn/art_editor/cocosstudio', ['.csd', '.png', '.jpg', '.JPG', '.PNG', '.txt', '.plist', '.fnt']);//, ['.plist', '.png', '.jpg', '.json']
// var dirList = ToolsHelper.getAllDirList('../svn/art_editor/cocosstudio').length;
